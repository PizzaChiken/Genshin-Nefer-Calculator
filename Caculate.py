...
from Characters.라우마 import AddLaumaTemp
from Characters.닐루 import AddNilouTemp

from Weapons.네페르전무 import NeferSignature
from Weapons.나히다전무 import AddNahidaSignatureTemp
from Weapons.라우마전무 import AddLaumaSignatureTemp
from Weapons.닐루전무 import AddNilouSignatureTemp

from Artifacts.하늘경계가드러난밤 import NightOfTheSkysUnveiling
from Artifacts.달을엮는밤노래 import AddSilkenMoonsSerenadeTemp
...
LaumaRefinements = 1
AddLaumaTemp(Calculator, Constellation=LaumaConstellation, EM = 1400, Moonsign=2)
AddLaumaSignatureTemp(Calculator, Refinements=LaumaRefinements)
AddSilkenMoonsSerenadeTemp(Calculator, PC=4, Moonsign=2)
...
TotalDMG += Nefer.SkillCACombine(Enemy, Print=False)
TotalDMG += Nefer.SkillCACombine(Enemy, Print=False)
TotalDMG += Nefer.UltCombine(Enemy)
